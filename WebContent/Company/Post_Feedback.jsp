			...
			<div class="page-header">
				...
				<div class="pull-right">
					<ul class="bread">
						...
						<li class='active'>Post Feedback</li>
					</ul>
				</div>
			</div>
					...
					<div class="span12">
						<div class="box">
							...
							<div class="box-body box-body-nopadding">
								...
								<form action="<%=request.getContextPath()%>/FeedbackController" method="POST" class='form-horizontal form-bordered form-validate' id="bb">
									...
									<div class="control-group">
										<label for="emailfield" class="control-label">Feedback</label>
										<div class="controls">
											<textarea name="feedback" id="textarea" class="input-block-level" data-rule-required="true" data-rule-minlength="10"></textarea>
										</div>
									</div>
