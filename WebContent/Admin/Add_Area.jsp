					...
					<div class="span12">
						<div class="box">
							...
							<div class="box-body box-body-nopadding">
								...
								<form action="<%=request.getContextPath()%>/AreaController" method="POST" class='form-horizontal form-bordered form-validate' id="bb">
								<div class="control-group">
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="area_Name" id="textfield" class="input-xlarge" data-rule-required="true" data-rule-minlength="2">
										</div>
									</div>
									...
									<div class="control-group">
										...
										<div class="controls">
											<textarea name="AreaDesc" id="textarea" class="input-block-level" data-rule-required="true" data-rule-minlength="10"></textarea>
										</div>
									</div>
