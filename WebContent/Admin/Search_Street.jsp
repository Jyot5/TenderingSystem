														...
														<table class="table table-nomargin table-bordered dataTable table-striped table-hover">
															...
															<c:forEach items="${sessionScope.search1}" var="se">
																<tr>
																	...
																	<td>${se.areaVO.area_Name}</td>
																	<td>${se.street_Name}</td>
																	<td>${se.street_Desc}</td>
																	<td><a href="<%=request.getContextPath()%>/StreetController?flag=edit&id=${se.street_ID}">Edit</a></td>
																	<td><a href="<%=request.getContextPath()%>/StreetController?flag=delete&id=${se.street_ID}">Delete</a></td>
