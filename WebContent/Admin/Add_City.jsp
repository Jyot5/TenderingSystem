					...
					<div class="span12">
						<div class="box">
							...
							<div class="box-body box-body-nopadding">
								...
								<form action="<%=request.getContextPath()%>/CityController" method="POST" class='form-horizontal form-bordered form-validate' id="bb">
									<div class="control-group">
										<label for="textfield" class="control-label">City Name</label>
										<div class="controls">
											<input type="text" name="City_Name" id="textfield" class="input-xlarge" data-rule-required="true" data-rule-minlength="2">
										</div>
									</div>
									...
									<div class="control-group">
										...
										<div class="controls">
											<textarea name="CityDesc" id="textarea" class="input-block-level" data-rule-required="true" data-rule-minlength="10"></textarea>
										</div>
									</div>
