					...
					<div class="span12">
						<div class="box">
							...
							<div class="box-body box-body-nopadding">
								...
								<form action="<%=request.getContextPath()%>/AreaController?id=${list1.area_ID}" method="POST" class='form-horizontal form-bordered form-validate' id="bb">
								<div class="control-group">
										...
										<div class="controls">
											<select name="City_ID" id="City_ID" data-rule-required="true">
												<c:forEach items="${sessionScope.edit1}" var="list">
													<c:if test="${list1.cityVO.city_ID==list.city_ID}">
													<option selected="selected" value="${list.city_ID}" >${list.city_Name}</option>
													</c:if>
													<c:if test="${list1.cityVO.city_ID!=list.city_ID}">
									...
									<div class="control-group">
										<label for="textfield" class="control-label">Area Name</label>
										<div class="controls">
											<input type="text" name="area_Name" id="textfield" class="input-xlarge" data-rule-required="true" data-rule-minlength="2" value="${list1.area_Name}">
										</div>
									</div>
									...
									<div class="control-group">
										...
										<div class="controls">
											<textarea name="AreaDesc" id="textarea" class="input-block-level" data-rule-required="true" data-rule-minlength="10">${list1.area_Desc}</textarea>
										</div>
									</div>
