														...
														<table class="table table-nomargin table-bordered dataTable table-striped table-hover">
															...
															<c:forEach items="${sessionScope.search4}" var="ser">
																<tr>
																	...
																	<td><a href="<%=request.getContextPath()%>/TenderDescController?flag=edit&id=${ser.tender_Id}">Edit</a></td>
																	<td><a href="<%=request.getContextPath()%>/TenderController?flag=delete&id=${ser.tender_Id}">Delete</a></td>
